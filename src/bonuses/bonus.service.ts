...
export class BonusService {
  ...
  async createNewBonus(document: Express.Multer.File, createBonusDto: CreateBonusDTO): Promise<Bonus> {
    ...
    return await this.bonusRepository.save({...createBonusDto, user: user, document: document?.buffer});
  }
}