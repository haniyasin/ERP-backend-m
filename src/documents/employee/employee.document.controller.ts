...
export class EmployeeDocumentController {
    ...
    async getAll(@Param() user: {id: number}): Promise<EmployeeDocument[] | null> {
    ...
    async createEmployeeDocument(
        ...
        return await this.employeeDocumentService.createNewEmployeeDocument(document, createEmployeeDocumentDTO);
    }
} 